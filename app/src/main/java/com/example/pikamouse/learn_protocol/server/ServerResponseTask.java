package com.example.pikamouse.learn_protocol.server;
...
import com.example.pikamouse.learn_protocol.utils.SocketUtil;
            ...
            while (!isCancle) {
                ...
                if (clientData != null) {
                    if (clientData.getProtocolType() == 0) {
                        System.out.println("length: " + ((DataProtocol)clientData).getLength() +",dtype: " + ((DataProtocol) clientData).getDtype() + ", pattion: " + ((DataProtocol) clientData).getPattion() + ", msgId: " + ((DataProtocol) clientData).getMsgId() + ", data: " + ((DataProtocol) clientData).getData());
